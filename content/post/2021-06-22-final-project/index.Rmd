...
1. Problem Statement: The goal of this project is to investigate data for median rent estimates (rent index) and rent per square foot over a 7-year period across counties and metropolitan areas in the United States in order to help citizens determine how much they would spend on rent in a specific location.

2. Motivation for selecting this topic: We are always concerned about the cost of living in various regions and which city is the best place to live in order to spend less and save more on a daily basis. I am sure everyone would agree that house rent is a significant component of a person's monthly expenses. I was curious about the trend of rents in major counties and cities in the United States, as well as the factors that influence them. As a result, I decided to take on this project.

3. Solution Overview: Using data exploration and visualisation tools, analyse and identify the trend of the rent index over time.
...
After cleaning, the dataset consists of 11 variables. Let us see what the datatype of each variable is:
...
ggplotly(heat_map, height = 900, width = 700)
```
